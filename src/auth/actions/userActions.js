...
const BASE_URL = process.env.REACT_APP_BASE_URL || "https://allwelluserservice.herokuapp.com"
...
export const loginUser = (credentials, history, setFieldError, setSubmitting) => {
    ...
    // check for user details 
        ...
        axios.post(`${BASE_URL}/api/users/signin/`,
        credentials,
        {
            headers: {
                "Content-Type": "application/json"
...
export const forgottenPassword = (credentials, history, setFieldError, setSubmitting) => {
    ...
    // check for user details 
        ...
        axios.post(`${BASE_URL}/api/users/forgotpassword/`,
        credentials,
        {
            headers: {
                "Content-Type": "application/json"
...
export const resetPassword = (credentials, history, setFieldError, setSubmitting, accessToken) => {
    return () => {
    // check for user details 
        axios.patch(`${BASE_URL}/api/users/changepassword/${accessToken}`,
